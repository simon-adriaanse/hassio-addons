...
| `san` | List of Subject Alternative Names. Accepts bare hostnames/IPs (auto-detected) or fully-qualified entries like `DNS:example.com` or `IP:192.168.1.1`. The CN is always included automatically. |
